...
function getWord1475() {
    return axios.get('https://ting0812/finalhomework_a1073305/txt/word1475.txt');
}
function getWeight1() {
    return axios.get('https://ting0812/finalhomework_a1073305/txt/weight1.txt');
}
function getFilename() {
    return axios.get('https://ting0812/finalhomework_a1073305/txt/filename.txt');
}
